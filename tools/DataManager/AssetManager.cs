...
namespace DataManager
{
    ...
    public class AssetManager
    {
        ...
        public static readonly string N3DSElfPath = "..\\..\\SC.elf";

        public bool Has3DSBuildTools { get; private set; }
        ...
        public void ReloadEverything(AsyncOperation op = null)
        {
            ...
            Has3DSBuildTools = File.Exists(tex3dsPath) && File.Exists(mkbcfntPath) && File.Exists(makeromPath);
