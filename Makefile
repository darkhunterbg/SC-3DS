...
TARGET		:=	SC
BUILD		:=	build
SOURCES		:=	src/3ds src/game src/game/LibSmacker src/game/Scenes src/game/SceneView src/game/GUI src/game/Loader src/game/Entity src/game/Data src/game/Engine
...
ifeq ($(DEBUG),1)
	CFLAGS	:=	-gdwarf -O1 -D_DEBUG -mword-relocations \
				-ffunction-sections \
				$(ARCH)
else
